...
public class EditPage extends WebPage {
	...
	static final String ATTACHEMENT_FORM = "attachementForm";
	...
	public EditPage(final PageParameters parameters) {
		...
		componentFactory.componetByPath(editForm, I18NEditPageModelParts.SaveButton.wicketId(), ActionButton.class).setVisible(editPageModelWeb.canBeSaved());
		...
		componentFactory.componetByPath(editForm, I18NEditPageModelParts.CancelButton.wicketId(), Button.class).setDefaultFormProcessing(false);
		...
		final Form<String> attachementForm = new Form<String>(ATTACHEMENT_FORM);
		...
		final ActionButton<String> deleteAttachementButton = (ActionButton<String>) componentFactory.newComponent(editPageModelWeb.getI18NAttachementLabels(), I18NAttachementsModelParts.DeleteButton, ActionButton.class);
		deleteAttachementButton.addActionListener(EditPageModel.DELETE_UPLOAD_ACTION, actionListener);
		deleteAttachementButton.addActionListener(action -> setResponsePage(EditPage.class));
		...
		group.add(new AjaxFormChoiceComponentUpdatingBehavior() {
			...
			protected void onUpdate(final AjaxRequestTarget target) {
				enableButtons(editPageModelWeb.isAttachementSelected(), deleteAttachementButton, showButton);
				target.add(deleteAttachementButton);
		...
		deleteAttachementButton.setVisible(editPageModelWeb.changeable());
		group.add(attachements);
		group.add(deleteAttachementButton);
		...
		uploadForm.setVisible(editPageModelWeb.changeable());
