...
public class EditPage extends WebPage {
	...
	@Inject()
	private IFormVisitorParticipant  fileUploadField; //= new FileUploadField("fileUpload");
	...
	public EditPage(final PageParameters parameters) {
		...
		fileUploadField=WebApplicationContextUtils.getRequiredWebApplicationContext(servletContext).getBean(FileUploadField.class);
		...
		/*	private static final long serialVersionUID = 1L;
			...
			protected void onSubmit() {
					...
					System.out.println(fileUpload.getFileUpload().getClientFileName());
	...
	//	final FileUploadField fileUploadField = new FileUploadField("fileUpload");
		final ActionForm<String>  uploadForm = new ActionForm<>("uploadForm");		
		uploadForm.addActionListener("uploadAction" ,  actionListener);
		
	
		//System.out.println(fileUploadField.getClass()); 
		uploadForm.add( (FileUploadField) fileUploadField);
