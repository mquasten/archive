...
public class EditPage extends WebPage {
	...
	private ActionListener<? extends Serializable> actionListener;
	...
	public EditPage(final PageParameters parameters) {
		...
		//};
		ActionForm<String,FileUpload>  uploadForm = new ActionForm<>("uploadForm", fileUpload.getFileUpload());		
		uploadForm.addActionListener("uploadAction" , (ActionListener<FileUpload>) actionListener);
